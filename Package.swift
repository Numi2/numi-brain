...
let package = Package(
  ...
  products: [
    ...
    .executable(name: "numi-brain-connectome", targets: ["NumiBrainConnectomeCLI"]),
  ...
  targets: [
    ...
    .target(name: "NumiBrainNumiLabBridgeABI", publicHeadersPath: "include"),
    ...
    .target(name: "NumiBrainMetal", dependencies: ["NumiBrainABI", "NumiBrainConnectomeABI", "NumiBrainCore", "NumiBrainQualification", "NumiBrainMetalBridgeABI", "NumiBrainNumiLabBridgeABI"], resources: [.process("Shaders")]),
    ...
    .testTarget(name: "NumiBrainMetalTests", dependencies: ["NumiBrainConnectomeTestSupport", "NumiBrainConnectomeABI", "NumiBrainCore", "NumiBrainMetal", "NumiBrainMLX", .product(name: "MLX", package: "mlx-swift")], resources: [.copy("Fixtures")]),
