...
root=/Users/n/NumiHumanBrainRuns/embodied-push-recovery-v5-push2-20260925
...
[[ $(shasum -a 256 "$library" | awk '{print $1}') == 21819958b40b789426a48925f1a2f1eef11ab4aebe1ecc04f334a0e0abb8ae69 ]]
