...
root=/Users/n/NumiHumanBrainRuns/embodied-push-recovery-v5-push3-20260925
...
[[ $(shasum -a 256 "$library" | awk '{print $1}') == 00713908cfd1825cd8b3efc6d938070428df708cdfaa8afdd9599908d9102e0f ]]
