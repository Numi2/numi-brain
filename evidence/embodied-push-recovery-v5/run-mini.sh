...
root=/Users/n/NumiHumanBrainRuns/embodied-push-recovery-v5-20260925
...
[[ $(shasum -a 256 "$library" | awk '{print $1}') == b26b2a97d6bfb0d06aff132c0e4fed1072b6e0ebdf056c6bab2d07853caebac6 ]]
