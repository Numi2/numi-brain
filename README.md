...
Bounded Apple M4 Pro and Apple M4 correctness probes of the v0.11 receptor-interrupt bridge are checked into [evidence/tissue-v0.11](evidence/tissue-v0.11/README.md). The larger 256x192 run was built and executed through `ssh macmini` after the prior crow workload ended; the smaller run is a second-device control. Earlier artifacts remain in predecessor directories. These are correctness and visual-inspection artifacts, not production performance qualifications.
